<div>
    <x-mary-header title="Oblasti" separator progress-indicator>
    ...
    <x-mary-modal wire:model="drawer" title="{{ $area ? 'Úprava oblasti' : 'Nová oblast' }}" separator with-close-button>
